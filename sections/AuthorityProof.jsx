  ...
  <section id="autoridade" className="py-20 px-6 bg-white border-b border-gray-100" aria-label="Prova de Autoridade">
    <div className="max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-6">
        {[
          { value: "+R$5 milhoes", label: "Faturados", icon: "💰", color: "text-orange-500", bg: "bg-orange-50" },
          ...
          { value: "Marca Propria", label: "Desenvolvimento e fabricacao", icon: "✅", color: "text-orange-500", bg: "bg-orange-50" },
        ].map((s, i) => (
          <motion.div
            key={s.value}
